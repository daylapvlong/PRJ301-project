            ...
            <div class="body_container">
                ...
                <div class="quiz_board">
                    <div class="quiz_container">
                        <ul class="quiz_navbar">
                            <li class="nav-item">Name</a></li>
                            <li class="nav-item">Date</a></li>
                            <li class="nav-item">Number of questions</a></li>
                            <li class="nav-item">Time</a></li>
                        </ul>
                        <div class="quiz_box">
                            <c:forEach begin="1" end="6" var="o">
                                <a href="#"></a>
                                    <ul class="quiz_content">
                                        <li class="quiz-item">PRJ PT1</a></li>
                                        <li class="quiz-item">12/06/2023</a></li>
                                        <li class="quiz-item">30</a></li>
                                        <li class="quiz-item">40 minutes</a></li>
                                    </ul>
                                </a>
                            </c:forEach>
                        </div>
